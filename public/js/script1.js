...
function populate() {
  ...
  function populateMetaDataConfig(data) {
    ...
    $('#download form').attr('action', 'https://formspree.io/' + data.contact_email);
  }
  ...
  function populatePageTitle(page, data) {
    ...
    $('#' + page + ' .heading h1').text(title).removeClass('hide-text');
    $('#' + page + ' .subheading h4').text(subtitle).removeClass('hide-text');
